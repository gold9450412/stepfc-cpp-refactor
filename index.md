...
將 StepFC 的 Step0（讀取 NES ROM）、Step1（CPU 記憶體位址空間 + Mapper000 + 中斷向量）、Step2（6502 反組譯器）用現代 C++ 重新實作的完整開發記錄。
...
| Step2 | 6502 反組譯器（指令表、13 種定址模式、CPU 暫存器、Disassembler） | [進入](step2/index.html) |
